...
<div class="content-wrapper">
    <h3 class="page-title">Tambah Paket Hosting</h3>

    <form action="<?= base_url('paket-hosting/store') ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" name="harga_perpanjangan" class="form-control" required>
        </div>
        <div class="form-group">
            <label>Lama Hosting</label>
            <input type="number" name="lama_hosting" class="form-control" required>
        </div>
        <div class="form-group">
            <label>Satuan Lama (bulan/tahun)</label>
            <input type="text" name="satuan_lama" class="form-control" required>
        </div>
